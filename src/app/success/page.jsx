...
export default function SuccessPage() {
  ...
  return (
    <div className="page-container flex items-center justify-center px-4 py-8 sm:py-12">
      <div className="w-full max-w-2xl">
        ...
        <div className="glass-card overflow-hidden shadow-2xl">
          <div className="p-6 sm:p-8 lg:p-10 space-y-5 sm:space-y-6">
            ...
            {/* Divider */}
            <div className="h-px bg-gradient-to-r from-transparent via-slate-300 dark:via-zinc-700 to-transparent"></div>
            ...
            <div className="space-y-4 sm:space-y-5">
              <div className="glass-card p-4 sm:p-5 space-y-2">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 space-y-1">
                    <h3 className="text-base sm:text-lg font-semibold text-theme">Confirmation Email Sent</h3>
              ...
              <div className="glass-card p-4 sm:p-5 space-y-2">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 space-y-1">
                    <h3 className="text-base sm:text-lg font-semibold text-theme">We'll Contact You Soon</h3>
                    <p className="text-xs sm:text-sm text-theme-secondary leading-relaxed">
                      Our team will reach out to you shortly for further communication regarding your order.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="glass-card p-4 sm:p-5 space-y-2">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 space-y-1">
                    <h3 className="text-base sm:text-lg font-semibold text-theme">Need to Update Your Address?</h3>
                    <p className="text-xs sm:text-sm text-theme-secondary leading-relaxed">
                      If there's an issue with your address or you need to make any changes, please contact us immediately.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="px-6 sm:px-8 lg:px-10 pb-6 sm:pb-8 lg:pb-10 space-y-3 sm:space-y-4">
            ...
            <button
              ...
              className="w-full py-3.5 sm:py-4 glass-card rounded-xl sm:rounded-2xl font-semibold text-sm sm:text-base text-theme hover:bg-theme-muted transition-all duration-300 flex items-center justify-center gap-2"
            >
              <svg
                className="w-5 h-5"
                fill="none"
        ...
        {/* Footer Note */}
        <p className="text-center text-xs sm:text-sm text-theme-secondary mt-6 px-4">
